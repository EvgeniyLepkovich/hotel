...
ym.modules.require(['system.supports.css', 'system.supports.graphics'], function (cssSupports, graphicsSupports) {
    ym.supports = {
        css: cssSupports,
        graphics: graphicsSupports,
        printPatchNeeded: !cssSupports.checkProperty('printColorAdjust') && !ym.env.enterprise
    };
});

})(this);

setupAsync({"key":undefined,"apikey":undefined,"browser":{"name":"Firefox","version":"50.0","engine":"Gecko","engineVersion":"50.0","osName":"Windows 10","osFamily":"Windows","osVersion":"10.0","isMobile":false,"cssPrefix":"Moz"},"lang":"ru_RU","languageCode":"ru","countryCode":"RU","hosts":{"api":{"main":"https://api-maps.yandex.ru/","ua":"https://yandex.ru/legal/maps_termsofuse/?lang={{lang}}","maps":"https://yandex.ru/maps/","statCounter":"https://yandex.ru/clck/","services":{"coverage":"https://api-maps.yandex.ru/services/coverage/","geocode":"https://geocode-maps.yandex.ru/","geoxml":"https://api-maps.yandex.ru/services/geoxml/","inception":"https://api-maps.yandex.ru/services/inception/","panoramaLocate":"https://api-maps.yandex.ru/services/panoramas/","search":"https://api-maps.yandex.ru/services/search/","suggest":"https://suggest-maps.yandex.ru/","regions":"https://api-maps.yandex.ru/services/regions/","route":"https://api-maps.yandex.ru/services/route/"}},"layers":{"map":"https://vec0%d.maps.yandex.net/tiles?l=map&%c&%l","sat":"https://sat0%d.maps.yandex.net/tiles?l=sat&%c&%l","skl":"https://vec0%d.maps.yandex.net/tiles?l=skl&%c&%l","stv":"https://0%d.srdr.maps.yandex.net/?l=stv&%c&v=%v&%l&action=render","sta":"https://lrs.maps.yandex.net/tiles?l=sta&%c&tm=%v&%l","staHotspot":"https://lrs.maps.yandex.net/tiles?l=stj&%c&tm=%v&%l","staHotspotKey":"%c&l=stj&tm=%v"},"traffic":"https://jgo.maps.yandex.net/","trafficArchive":"https://jft.maps.yandex.net/"},"layers":{"map":{"version":"17.03.03-0","scaled":true,"hotspotZoomRange":[13,23]},"sat":{"version":"3.303.0"},"skl":{"version":"17.03.03-0","scaled":true,"hotspotZoomRange":[13,23]},"trf":{"version":"1489494365","scaled":true},"sta":{"version":"0.27.4-0.1.2.1-0.2017.03.07.15.00.2.25.8-2.stable"},"stv":{"version":"3.51.0"}},"geolocation":{"longitude":27.561831,"latitude":53.902257,"isHighAccuracy":false,"span":{"longitude":0.688675,"latitude":0.177708}},"token":"661ecde0dfd063230bd97f0918b23ae6","sign":(function(r){function t(e){if(n[e])return n[e].exports;var o=n[e]={exports:{},id:e,loaded:!1};return r[e].call(o.exports,o,o.exports,t),o.loaded=!0,o.exports}var n={};return t.m=r,t.c=n,t.p="",t(0)})([function(r,t,n){"use strict";function e(){for(var r=["f","d","2","2","3","5","b","a","9","9","6","5","4","d","5","4","3","8","c","4","3","9","d","c","d","6","9","a","6","e","1","9","2","1","a","9","9","e","7","a"],t=[[SVGLength.SVG_LENGTHTYPE_PERCENTAGE+11,XMLHttpRequest.OPENED],[SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_NONE+19,document.createAttribute("xy").nodeType],[DOMException.DOMSTRING_SIZE_ERR+1,SVGTransform.SVG_TRANSFORM_SKEWY+33]],n=0;n<t.length;n++){var e=t[n][0],o=t[n][1],i=r[e];r[e]=r[o],r[o]=i}return r.join("")}var o,i=n(1),u=n(2);r.exports=function(r){return o||(o=i(e())),i(u(r),o)}},function(r,t){"use strict";r.exports=function(r,t){t=t||0;for(var n=0;n<r.length;n++)t+=(t<<1)+(t<<4)+(t<<7)+(t<<8)+(t<<24),t^=r.charCodeAt(n);return t>>>0}},function(r,t){"use strict";r.exports=function(r){r=r.replace(/^.*\/\//,"");var t=r.indexOf("?");if(-1===t)return r;var n=t+1,e=r.indexOf("#",n);-1===e&&(e=r.length);var o=r.substring(n,e).split("&",1e3);return r.substring(0,n)+o.sort().join("&")+r.substring(e)}}]),"distribution":{},"version":"2.1.48","majorVersion":"2.1","cssPrefix":"ymaps-2-1-48-","server":{"url":"//api-maps.yandex.ru/2.1.48","path":"./build/debug/","params":{"mode":"debug"}},"preload":{"load":"package.full"},"mode":"debug","debug":true,"coordinatesOrder":"latlong"});})(this);